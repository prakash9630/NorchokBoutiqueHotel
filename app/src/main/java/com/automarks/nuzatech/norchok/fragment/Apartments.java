...
import com.automarks.nuzatech.norchok.Pojo.Appartment_type_data;
...
//                            if (json instanceof JSONArray)
                            ...
                            apartments.setDiscount(obj.getString("Discount"));
                            apartments.setNightprice(obj.getString("Price Today"));
...
//
    ...
    class ApartmentAdapter extends RecyclerView.Adapter<ApartmetnHolder> {
        ...
        public void onBindViewHolder(ApartmetnHolder holder, int position) {
            ...
            holder.base.setText("$" + current.getPrice() + " /Night ");
            holder.week.setText("$" + current.getWeekprice() + " /Week ");
            holder.month.setText("$" + current.getMonthprice() + " /Month");
            holder.discountprice.setText(current.getDiscount()+"% OFF TODAY");
            holder.nightprice.setText("$"+current.getNightprice());
    ...
    class ApartmetnHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView image;
        TextView uniteType, base,week,month,discountprice,nightprice;
        Context context;
        ...
        public ApartmetnHolder(View itemView, Context context, ArrayList<Appartment_type_data> data) {
            ...
            discountprice=(TextView)itemView.findViewById(R.id.discountedPercent);
            nightprice=(TextView)itemView.findViewById(R.id.currentrate);
