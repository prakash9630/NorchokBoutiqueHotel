...
import com.automarks.nuzatech.norchok.Pojo.Album_photo;
        ...
        public void onBindViewHolder(AlbumHolder holder, final int position) {
            ...
            holder.image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final PhotoView ivZoomedImage = (PhotoView) dialog.findViewById(R.id.fullscreen_image);
                    ...
                    Picasso.with(context)
                            .load("https://www.retreatservicedapartments.com/sites/default/files/"+imgUrl)
                            .into(ivZoomedImage);
