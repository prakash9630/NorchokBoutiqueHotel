...
//        }
    ...
    private class GetLatestVersion extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            Log.e("erroro yo ho",""+params);
            try {


//It retrieves the latest version by scraping the content of current version from play store at runtime
                Document doc = Jsoup.connect("https://play.google.com/store/apps/details?id=com.ca.prakash.RetreatServicedApartment&hl=en").get();
        ...
        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse
                        ("market://details?id=com.ca.prakash.RetreatServicedApartment")));
                dialog.dismiss();
            }
        });
