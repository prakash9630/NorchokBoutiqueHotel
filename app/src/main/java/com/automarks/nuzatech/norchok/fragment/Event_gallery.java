...
import com.automarks.nuzatech.norchok.activity.Place_detail;
...
public class Event_gallery extends android.support.v4.app.Fragment{
    View mainView;
    ProgressDialog pDilog;
    String url = Public_Url.eventgalleryAlbum;
    Album_data gallery;
    RecyclerView recycler;
    FrameLayout frame;

    EventGalleryRecycler adapter;
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        if (obj != null) {
                            ...
                            gallery.setMunitname(obj.getString("title"));
                            ...
                            adapter = new EventGalleryRecycler(getContext(), data);
...
//                            recycler.setLayoutManager(new LinearLayoutManager(Album_View_Gallery.this));
    ...
    class EventGalleryRecycler extends RecyclerView.Adapter<EventGalleryHolder> {

        Context context;
        ArrayList<Album_data> data;
        LayoutInflater layoutinflater;

        public EventGalleryRecycler(Context context, ArrayList<Album_data> data) {
        ...
        @Override
        public EventGalleryHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = layoutinflater.inflate(R.layout.gallery_album_design, parent, false);
            EventGalleryHolder holder = new EventGalleryHolder(view, context, data);
            return holder;
        }

        @Override
        public void onBindViewHolder(final EventGalleryHolder holder, int position) {
    ...
    class EventGalleryHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ImageView gImage;
        TextView mText;
        ...
        public EventGalleryHolder(View itemView, Context context, ArrayList<Album_data> data) {
            super(itemView);
            this.context = context;
            this.data = data;
